...
describe User do
  before do 
  	@user = User.new(name: "Example User",email: "useremail@example.com",
  ...
  it { should respond_to(:remember_token)} #8.15
  ...
  it { should respond_to(:followed_users)} #11.1.4
  ...
  describe "when email address is already taken" do
  	before do	
  		user_with_same_email = @user.dup   #creates duplicate user
  ...
  describe "email address with mixed case " do
  	...
  	it  "shoud be saved as lower case" do
  ...
  describe "micropost associations" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.microposts.create!(content: "John Meehan")}
      end
